...
namespace YourITMatch.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Należy wpisać obecne hasło")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!changePasswordResult.Succeeded)
            {
                ...
                {
                    if (error.Description.ToString() == "Incorrect password.") error.Description = "Wpisane obecne hasło jest nieprawidłowe";
